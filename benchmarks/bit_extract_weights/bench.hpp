...
std::uint64_t run_var_bitloop(BitExtractWeightsBatch const& batch, std::size_t rounds);
std::uint64_t run_var_split32(BitExtractWeightsBatch const& batch, std::size_t rounds);
std::uint64_t run_var_byte_table(BitExtractWeightsBatch const& batch, std::size_t rounds);

std::uint64_t run_var_block_table(BitExtractWeightsBatch const& batch, std::size_t rounds);
std::uint64_t run_var_block_table_unrolled1(BitExtractWeightsBatch const& batch, std::size_t rounds);
std::uint64_t run_var_block_table_unrolled2(BitExtractWeightsBatch const& batch, std::size_t rounds);
std::uint64_t run_var_block_table_unrolled4(BitExtractWeightsBatch const& batch, std::size_t rounds);
std::uint64_t run_var_block_table_unrolled8(BitExtractWeightsBatch const& batch, std::size_t rounds);

std::uint64_t run_var_butterfly_table(BitExtractWeightsBatch const& batch, std::size_t rounds);
...
std::uint64_t run_var_zp7(BitExtractWeightsBatch const& batch, std::size_t rounds);
