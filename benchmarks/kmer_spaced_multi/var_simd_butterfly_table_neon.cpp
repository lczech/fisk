...
std::uint64_t run_var_simd_butterfly_table_neon(std::string const& seq, std::size_t k, BitExtractKernelDispatcher<BitExtractKernelButterflyNEON> const& kernel)
{
    std::uint64_t hash = 0;
