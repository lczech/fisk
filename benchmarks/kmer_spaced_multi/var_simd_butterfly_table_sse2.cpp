...
std::uint64_t run_var_simd_butterfly_table_sse2(std::string const& seq, std::size_t k, BitExtractKernelDispatcher<BitExtractKernelButterflySSE2> const& kernel)
{
    std::uint64_t hash = 0;
