...
std::uint64_t run_var_simd_butterfly_table_avx512(std::string const& seq, std::size_t k, BitExtractKernelDispatcher<BitExtractKernelButterflyAVX512> const& kernel)
{
    std::uint64_t hash = 0;
