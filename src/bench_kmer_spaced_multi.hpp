    ...
    for( size_t m = 0; m < multi_masks.size(); ++m) {
        ...
        auto results = suite.run(
            ...
            bench(
                ...
                [&](std::string const& seq){
                    return compute_spaced_kmer_hash(
                        seq, k, bit_ext_masks, char_to_nt_table_throw, bit_extract_pext
                    );
                }
            ),
            #endif
            bench(
                ...
                [&](std::string const& seq){
                    return compute_spaced_kmer_hash(
                        seq, k, bit_ext_masks, char_to_nt_table_throw, bit_extract_bitloop
                    );
                }
            ),
            bench(
                ...
                [&](std::string const& seq){
                    return compute_spaced_kmer_hash(
                        seq, k, bit_ext_masks, char_to_nt_table_throw, bit_extract_byte_table
                    );
                }
            ),
            bench(
                ...
                [&](std::string const& seq){
                    return compute_spaced_kmer_hash(
                        seq, k, bit_ext_block_masks, char_to_nt_table_throw, bit_extract_block_table
                    );
                }
            ),
            bench(
                ...
                [&](std::string const& seq){
                    return compute_spaced_kmer_hash(
                        seq, k, bit_ext_block_masks, char_to_nt_table_throw, bit_extract_block_table_unrolled<2>
                    );
                }
            ),
            bench(
                ...
                [&](std::string const& seq){
                    return compute_spaced_kmer_hash(
                        seq, k, bit_ext_block_masks, char_to_nt_table_throw, bit_extract_block_table_unrolled<4>
                    );
                }
            ),
            bench(
                ...
                [&](std::string const& seq){
                    return compute_spaced_kmer_hash(
                        seq, k, bit_ext_block_masks, char_to_nt_table_throw, bit_extract_block_table_unrolled<8>
                    );
                }
            ),
            bench(
                ...
                [&](std::string const& seq){
                    return compute_spaced_kmer_hash(
                        seq, k, bit_ext_network_tables, char_to_nt_table_throw, bit_extract_network_table
                    );
                }
            ),
